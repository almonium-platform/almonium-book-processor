...
| P2-2 | processor; P1-2 | Current priority (2026-09-14): [paid B2 chapter pilot](ADAPTATION_PILOT.md) with source snapshots, keep/adapt decisions and staff side-by-side review implemented. Review Frankenstein directly from the original C1; no prerequisite modernization or calibration project. Next: complete aligned B2 edition, fidelity review and difficulty reassessment. Original remains publishable independently. Add B1 after pilot review. |
